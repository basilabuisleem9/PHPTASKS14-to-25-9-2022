                            ...
                            if ($_POST['date'] != "") {
                                ...
                                if ($_POST['password'] != "") {
                                    ...
                                    if ($_POST['passwordconfirm'] != "") {
                                        ...
                                        $conn->query("INSERT INTO `adminuser`(email_address,first_name,middle_name,last_name,family_name,mobile,date_of_birth,password,confirm_password) 
                                        VALUES('$email','$fname','$mname','$lname','$famname','$mobile','$date','$password','$passwordconfirm')");
